...
<div>
	<ul class="nav menu">
		...
		<li id="hadoop_request"><a href="hadoop_request.php"><svg class="glyph stroked-dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg>Hadoop Request</a></li>
		...
		<li id="management"><a href="#manage-collapse" data-toggle="collapse"><span class="glyphicon glyphicon-cog"></span>Management&nbsp;&nbsp;&nbsp;<span id="arrow" class="glyphicon glyphicon-chevron-down"></span></a>
			<ul class=" nav menu collapse" id="manage-collapse">
				...
				<li id="ip_pool"><a href="ip_pool.php"><span class="glyphicon glyphicon-info-sign">
				Ip Pool</span></a></li>
			</ul>
		</li>	
		<?php	
